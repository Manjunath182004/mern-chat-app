    ...
    <h1 className='text-3xl font-semibold text-center text-gray-300'> Sign Up
        ...
        <form>
            <div>
                ...
                <input type="password" placeholder='abhijeet' className='w-full input input-bordered h-10'  />           
            ...
            <div>
                ...
                <input type="password" placeholder='abhi' className='w-full input input-bordered h-10'  />           
            </div>
